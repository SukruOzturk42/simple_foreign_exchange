package com.openpayd.exchange.infrastructure.config.localization;
...
public class LocalizationConfiguration extends AcceptHeaderLocaleContextResolver implements WebMvcConfigurer {
    ...
    private static final String DEFAULT_LANGUAGE_NAME = "en_EN";
    private static final List<String> SUPPORTED_LANGUAGE = List.of(DEFAULT_LANGUAGE_NAME,"tr_TR");


    @Bean
    public ResourceBundleMessageSource messageSource() {
        ResourceBundleMessageSource source = new ResourceBundleMessageSource();
        source.setBasenames("i18n/BusinessMessages","i18n/ValidationMessages");
